...
namespace MyProject
{
    ...
    {
    public:
        AZ_RTTI(MyProjectModule, "{FEC806B1-5ABC-448B-B07A-F6DCC0F2C75B}", AZ::Module);
...
AZ_DECLARE_MODULE_CLASS(MyProject_d45b470ceb024500a906bb0f71f67bf7, MyProject::MyProjectModule)
